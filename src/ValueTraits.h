...
#ifndef SHAREMIND_EMULATOR_PROTOCOLS_VALUETRAITS_H
#define SHAREMIND_EMULATOR_PROTOCOLS_VALUETRAITS_H
...
struct __attribute__ ((visibility("internal"))) is_any_value_tag :
    std::is_base_of<any_value_tag, typename value_traits<T>::value_category>
{ };

} /* namespace sharemind */

#endif /* SHAREMIND_EMULATOR_PROTOCOLS_VALUETRAITS_H */
