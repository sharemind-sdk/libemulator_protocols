...
#ifndef SHAREMIND_EMULATOR_PROTOCOLS_SHAREVECTOR_H
#define SHAREMIND_EMULATOR_PROTOCOLS_SHAREVECTOR_H
...
template <typename T> class share_vec;

struct __attribute__ ((visibility("internal"))) share_vec_base {
public: /* Types: */
    virtual ~share_vec_base () {}
};
...
template <typename T, class C = share_vec<T> >
 ...
 */
template <typename T>
class __attribute__ ((visibility("internal"))) share_vec : public share_vec_base {
public: /* Types: */
    ...
    typedef share_iterator<T, share_vec<T> > iterator;
    typedef share_const_iterator<T, share_vec<T> > const_iterator;
...
public: /* Methods: */
    ...
    share_vec (InputIterator begin, InputIterator end)
        : m_vector (begin, end)
    { }
    ...
    inline void assign (const share_vec& vec) {
...
#endif /* SHAREMIND_EMULATOR_PROTOCOLS_SHAREVECTOR_H */
